...
let CreateFighterInput = (() => {
    ...
    var CreateFighterInput = _classThis = class {
        constructor() {
            ...
            this.nickname = (__runInitializers(this, _weightClass_extraInitializers), __runInitializers(this, _nickname_initializers, void 0));
            this.wins = (__runInitializers(this, _nickname_extraInitializers), __runInitializers(this, _wins_initializers, void 0));
    ...
    __setFunctionName(_classThis, "CreateFighterInput");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _firstName_decorators = [Field()];
        _lastName_decorators = [Field()];
        _weightClass_decorators = [Field()];
        _nickname_decorators = [Field()];
        _wins_decorators = [Field()];
        _losses_decorators = [Field()];
        _photoUrl_decorators = [Field()];
        _bio_decorators = [Field()];
        ...
        CreateFighterInput = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return CreateFighterInput = _classThis;
})();
export { CreateFighterInput };
