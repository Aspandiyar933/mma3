...
let Event = (() => {
    ...
    var Event = _classThis = class {
        constructor() {
            ...
            this.date = (__runInitializers(this, _location_extraInitializers), __runInitializers(this, _date_initializers, void 0)); // Ensure this is ISO-8601 formatted
            this.fights = (__runInitializers(this, _date_extraInitializers), __runInitializers(this, _fights_initializers, void 0));
    ...
    (() => {
        ...
        _name_decorators = [Field(), Column()];
        _location_decorators = [Field(), Column()];
        _date_decorators = [Field(), Column()];
        _fights_decorators = [Field(() => [Fight], { nullable: true }), OneToMany(() => Fight, (fight) => fight.event)];
